...
--------------------------------------------------------------------
local Library = Update:Window("LeNhat XP Hub ","")
------------------------------------------
...
Setting:Label("Tham Gia Discord Để Hóng Update.!")

Setting:Line()

Setting:Button("Sao Chép Link Discord",function()
 
 setclipboard("https://discord.gg/Z2YZpdx8YS")
 end)
...
Main:Toggle("Auto Địt All Boss",_G.Auto_Farm_All_Boss,function(value)
...
wait(1)
Notification:Notify(
   {Title = "Le Van Nhat XP Hub", Description = "Cấp Độ Haki (Max)"},
